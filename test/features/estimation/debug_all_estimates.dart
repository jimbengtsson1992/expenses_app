...
void main() async {
  test('Generate All Estimates Report', () async {
    ...
    sink.writeln('Period: $targetYear-${targetMonth.toString().padLeft(2, '0')}');
    sink.writeln('=================================================================\n');
    ...
    for (final category in Category.values) {
        ...
        final categoryTxs = allTransactions.where((t) => t.category == category).toList();
        final distinctSubcategories = categoryTxs.map((t) => t.subcategory).toSet().toList();
        ...
        for (final sub in distinctSubcategories) {
            ...
            final report = explainer.explain(category, sub, showDetails: false); // Default summary
            sink.writeln(report);
